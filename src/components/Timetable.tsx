export default function Timetable({ timetable, slottedElectives }: { timetable: Array<any>, slottedElectives: any }) {
  ...
  return (
    <div className="max-w-screen-xl mx-auto pt-12" style={{ minHeight: "100vh" }}>
      <div className="grid grid-cols-7 grid-rows-12 gap-1 border-2 rounded-lg border-neutral-400" style={{ minHeight: "72vh" }}>
        <div
          className="row-start-1 row-end-2 bg-neutral-800 rounded-md text-center py-3"
          style={{ borderTopLeftRadius: "7.626px" }}
        ></div>
        <div className="row-start-1 row-end-2 bg-neutral-800 rounded-md text-center py-3">
          <span className="hidden xl:block">Monday</span>
          <span className="xl:hidden">M</span>
        </div>
        <div className="row-start-1 row-end- bg-neutral-800 rounded-md text-center py-3">
        ...
        <div className="col-start-1 col-end-2 bg-neutral-800 rounded-md text-center py-3">
        ...
        <div
          className="col-start-1 col-end-2 bg-neutral-800 rounded-md text-center py-3"
